...
try {
    ...
    Invoke-NativeChecked { & py -3 -m py_compile `
        ...
        codex_discord_prefix_gpt_commands.py `
        ...
        tests\test_codex_discord_gpt_integration.py `
        tests\test_codex_discord_help.py `
